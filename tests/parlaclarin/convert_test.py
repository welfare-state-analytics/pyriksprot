...
def test_convert_to_xml():
    ...
    speeches: List[interface.Speech] = speech.to_speeches(protocol=protocol, merge_strategy='chain')
...
Ove är dum.
    ...
    speeches: List[interface.Speech] = speech.to_speeches(protocol=protocol, merge_strategy='who')
