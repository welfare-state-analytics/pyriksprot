...
from pyriksprot import interface, segment
...
def test_convert_to_xml():
    ...
    speeches: List[interface.Speech] = segment.to_speeches(protocol=protocol, merge_strategy='chain')
...
Ove är dum.
    ...
    speeches: List[interface.Speech] = segment.to_speeches(protocol=protocol, merge_strategy='who')
