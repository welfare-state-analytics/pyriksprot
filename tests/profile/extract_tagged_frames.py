...
def main(target_type: dispatch.TargetTypeKey, source_folder: str):
    ...
    tagged_corpus.extract_corpus_tags(
        ...
        target_name=f'/data/riksdagen_corpus_data/{target_type}_{basename(source_folder)}/',
...
if __name__ == '__main__':
    ...
    source_folder: str = '/data/riksdagen_corpus_data/tagged_frames_v0.3.0_20201218'
