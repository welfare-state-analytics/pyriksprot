...
# from pyriksprot.purgatory import member as pm

# from ...tests.utility import PARLACLARIN_SOURCE_FOLDER
...
#     member_index = memberpm.ParliamentaryMemberIndex(source=PARLACLARIN_SOURCE_FOLDER)
