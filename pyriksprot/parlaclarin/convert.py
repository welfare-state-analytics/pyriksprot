...
def convert_protocol(
    ...
    merge_strategy: segment.MergeUtteranceStrategyType = segment.MergeUtteranceStrategyType.who_speaker_hash_sequence,
    **dehyphen_cfg,
):
    ...
    if protocol.has_text:
        ...
        speeches: List[interface.Speech] = segment.to_speeches(protocol=protocol, merge_strategy=merge_strategy)
